...
import { Monitor, Cpu, HardDrive, Wifi, Activity, Terminal, Shield, RefreshCw, AlertCircle, CheckCircle2 } from "lucide-react";
...
export const RmmPage: React.FC = () => {
  ...
  const { data: endpointsData = [], isLoading, refetch } = useQuery({
    ...
    refetchInterval: 10000, // Live 10s telemetry polling
  });
    ...
    <div className="space-y-6 font-body">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-border/40 pb-5">
        <div>
          ...
          <h1 className="text-2xl font-black font-display text-text">Endpoint Monitoring &amp; Live Telemetry</h1>
          <p className="text-xs text-muted mt-0.5">
            Real-time CPU, RAM, Disk, and network telemetry for Windows, macOS &amp; Linux RemoteFix RMM agents.
          </p>
        </div>
